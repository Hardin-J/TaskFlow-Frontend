    ...
    <>
      <div 
        className={`${
          ...
          darkMode ? "bg-slate-900/90 border-r border-slate-700/50" : "bg-white/90 border-r border-slate-200/50"
      ...
      >
        <div className="flex items-center justify-between p-4 h-16 border-b border-opacity-30 mb-4">
          <div className={`flex items-center ${sidebarCollapsed ? "justify-center w-full" : ""}`}>
            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-md">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-white">
                <path fillRule="evenodd" d="M3 6a3 3 0 013-3h12a3 3 0 013 3v12a3 3 0 01-3 3H6a3 3 0 01-3-3V6zm4.5 7.5a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm0-4.5a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm9-4.5a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm0 9a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5z" clipRule="evenodd" />
              </svg>
            </div>
            {!sidebarCollapsed && (
          ...
          <button 
            ...
            className={`p-1 rounded-md ${darkMode ? "hover:bg-slate-700" : "hover:bg-slate-200"} ${sidebarCollapsed ? "hidden" : ""}`}
          >
    ...
    {!sidebarCollapsed && <span className="ml-3">My Works</span>}
              ...
              <li className="relative">
                ...
                {showWorkspaceDropdown && !sidebarCollapsed && (
                  <div className={`mt-1 py-1 rounded-md shadow-lg ${
